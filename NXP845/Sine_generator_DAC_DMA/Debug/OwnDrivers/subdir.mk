...
clean: clean-OwnDrivers

clean-OwnDrivers:
	-$(RM) ./OwnDrivers/freq_boton.d ./OwnDrivers/freq_boton.o ./OwnDrivers/sine_generator.d ./OwnDrivers/sine_generator.o

.PHONY: clean-OwnDrivers
