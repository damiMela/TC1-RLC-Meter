  ...
  - fsl_dma:
    ...
    - dma_channels:
      - 0:
        ...
        - trans_config:
          - init_callback: 'true'
          - callback_function: 'DAC_DMA_Callback'
          - callback_user_data: ''
        - tcd_config:
          - 0:
            - tcdID: 'CH0_TCD0'
            ...
            - srcAddr:
              - addrType: 'startAddr'
              - addr_expr: '&SinusOutputData[0]'
              - addr_def: 'uint32_t SinusOutputData[100]'
            - dstAddr:
              - addrType: 'startAddr'
              - addr_expr: '&DAC0->CR'
              - addr_def: ''
...
AT_NONCACHEABLE_SECTION_ALIGN(dma_descriptor_t DMA0_CH0_TCDs_config[1], FSL_FEATURE_DMA_LINK_DESCRIPTOR_ALIGN_SIZE)
 = {
  {
    .xfercfg = DMA_CHANNEL_XFER(true, true, true, false, kDMA_Transfer32BitWidth, kDMA_AddressInterleave1xWidth, kDMA_AddressInterleave0xWidth, 400U),
    .srcEndAddr = (void *)DMA_DESCRIPTOR_END_ADDRESS(&SinusOutputData[0], (uint32_t)kDMA_AddressInterleave1xWidth, 400U, (uint32_t)kDMA_Transfer32BitWidth),
    .dstEndAddr = (void *)DMA_DESCRIPTOR_END_ADDRESS(&DAC0->CR, (uint32_t)kDMA_AddressInterleave0xWidth, 400U, (uint32_t)kDMA_Transfer32BitWidth),
...
static void DMA0_init(void) {
  ...
  DMA_SetCallback(&DMA0_CH0_Handle, DAC_DMA_Callback, NULL);
