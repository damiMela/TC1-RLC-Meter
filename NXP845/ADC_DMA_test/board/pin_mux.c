...
- pin_list:
  - {pin_num: '33', peripheral: ADC0, signal: 'CH, 0', pin_signal: PIO0_7/ADC_0, mode: inactive, clkdiv: div0}
...
void BOARD_InitPins(void)
{
    ...
    IOCON->PIO[15] = ((IOCON->PIO[15] &
                       /* Mask bits to zero which are setting */
                       (~(IOCON_PIO_MODE_MASK | IOCON_PIO_CLK_DIV_MASK)))
                       ...
                       * IOCONCLKDIV0 */
                      | IOCON_PIO_CLK_DIV(PIO0_7_CLK_DIV_0b000));
