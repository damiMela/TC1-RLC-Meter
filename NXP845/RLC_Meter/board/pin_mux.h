...
#define BOARD_INITPINS_POT_UD_GPIO GPIO                 /*!<@brief GPIO peripheral base pointer */
#define BOARD_INITPINS_POT_UD_GPIO_PIN_MASK (1U << 14U) /*!<@brief GPIO pin mask */
#define BOARD_INITPINS_POT_UD_PORT 0U                   /*!<@brief PORT device index: 0 */
#define BOARD_INITPINS_POT_UD_PIN 14U                   /*!<@brief PORT pin number */
#define BOARD_INITPINS_POT_UD_PIN_MASK (1U << 14U)      /*!<@brief PORT pin mask */
                                                        /* @} */
...
/* Symbols to be used with GPIO driver */
#define BOARD_INITPINS_POT_INC_GPIO GPIO                 /*!<@brief GPIO peripheral base pointer */
#define BOARD_INITPINS_POT_INC_GPIO_PIN_MASK (1U << 13U) /*!<@brief GPIO pin mask */
#define BOARD_INITPINS_POT_INC_PORT 0U                   /*!<@brief PORT device index: 0 */
